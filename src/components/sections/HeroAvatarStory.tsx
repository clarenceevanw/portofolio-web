...
export function HeroAvatarStory() {
    ...
    const initGSAP = async () => {
      ...
      ctx = gsap.context(() => {
        ...
        media.add('(min-width: 768px)', () => {
          // Setting up GSAP timeline for scrubbing the video time
          const tl = gsap.timeline({
            scrollTrigger: {
              ...
              pin: true,
              pinSpacing: true,
              scrub: 1, // Angka ini memberikan efek 'easing' (meluncur) agar tidak kaku
              anticipatePin: 1,
  ...
  return (
    ...
    >
      {/* Background video that scrubs on scroll */}
      <video
        ref={videoRef}
